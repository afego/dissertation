...
%\textit{\textbf{Andre}  como nos capitulos anteriores inclua um pequeno texto antes de iniciar as divisoes do capitulo em seções. Mudei a ordem e fiz pequenas correções, pois nem tudo estava bem correto no seu texto!}
...
% -----------------------
%\textit{\textbf{Andre}  essa divisão de  seções não faz o menor sentido ja que não havera outra conversão no seu texto!}

\subsection{Conversão de RGB para YCrCb}
% https://docs.opencv.org/4.6.0/de/d25/imgproc_color_conversions.html
